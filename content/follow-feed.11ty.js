module.exports = class {
	...
	async render() {
		...
		feed.addSource("atom", "raincastle.blog", "https://raincastle.blog/blog.rss");
		feed.addSource("rss", "3 Schweinehunde Podcast", "https://3-schweinehun.de/episodes.mp3.rss");
		feed.addSource("rss", "Epigenetics Podcast", "https://activemotif.podbean.com/feed.xml");
		feed.addSource("rss", "Mastodon", "https://sueden.social/users/johndillinger15.rss");
		feed.addSource("rss", "Strava Activities", "https://feedmyride.net/activities/6023237");
